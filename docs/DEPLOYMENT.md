...
4. Set production `GOOGLE_CLIENT_ID` and secret `GOOGLE_CLIENT_SECRET` in Cloudflare Pages. Set `APP_ORIGIN=https://addiction-breaker.pages.dev`. Google stores the identity; this app stores the corresponding subject, email and display name.
